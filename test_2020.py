...
# Extract feature
with torch.no_grad():
    gallery_feature, gallery_view = extract_feature(model,model_view,dataloaders['gallery'])
    query_feature, query_view = extract_feature(model,model_view,dataloaders['query'])

# Save to Matlab for check
result = {'gallery_f':gallery_feature.numpy(),'gallery_v':gallery_view.numpy(),'gallery_label':gallery_label,'gallery_cam':gallery_cam,'query_f':query_feature.numpy(),'query_v':query_view.numpy(),'query_label':query_label,'query_cam':query_cam}
